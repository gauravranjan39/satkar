<div class="be-content">
    ...
    <?php echo $this->Session->flash(); ?>
        ...
        <div class="col-sm-12">
            ...
            <?php echo $this->Form->create('Customer',array('url'=> array('controller' => 'Customers', 'action' => 'admin_add'),'method'=>'POST')); ?>
                ...
                <div class="row xs-pt-15">
					...
					<?php echo $this->Html->link('cancel', array('controller' => 'customers','action' => 'admin_index'),array('class'=>'btn btn-space btn-default',));?>
                    </div>
                </div>
    ...
    $(document).ready(function() {
        ...
        $('.search_reference').click(function(){
            ...
            if (searchData == '') {
                ...
                $.ajax({
                    type: "POST",
                    url:"<?php echo Router::url(array('controller'=>'customers','action'=>'admin_check_customer'));?>",
