						...
						<td class="center">
							<div class="btn-group btn-hspace">
								...
								<ul role="menu" class="dropdown-menu pull-right">
									...
									<li><?php echo $this->Html->link('Edit', array('controller' => 'Customers','action' => 'admin_edit',$customerList['c1']['id']),array('class'=>''));?></li>
									<!-- <li><?php //echo $this->Html->link('Add Ledger', array('controller' => 'Orders','action' => 'add',$encodedCustomerId),array('class'=>''));?></li> -->
									<li><?php echo $this->Html->link('Orders', array('controller' => 'Orders','action' => 'admin_index',$encodedCustomerId),array('class'=>''));?></li>
									<li><?php echo $this->Html->link('Passbook', array('controller' => 'Wallets','action' => 'admin_index',$encodedCustomerId),array('class'=>''));?></li>
								</ul>
							</div>
						</td>
						</tr>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$(".status").click(function(){
			...
			var ref = $(this);
			$.ajax({
				url:"<?php echo Router::url(array('controller'=>'Customers','action'=>'admin_change_status'));?>/"+val,
