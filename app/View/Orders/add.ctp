						...
						<?php echo $this->Form->create('Order',array('url'=> array('controller' => 'Orders', 'action' => 'add',$customerId),'method'=>'POST')); ?>
							<div class="clone-div" id="clonedInput_0" data-count-val="0">
								...
								<div class="row xs-pt-12">
									...
									<div class="form-group col-sm-6">
										<label>Item</label>
										<?php echo $this->Form->input("OrderItem.name",array('name'=>'data[OrderItem][0][name]','id'=>'OrderItemName_0','placeholder'=>'Enter Item','required'=>'required','class'=>'form-control input-sm itemName speechText','label'=>false));?>
									</div>
								</div>
